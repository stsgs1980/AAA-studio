...
export default function SettingsPage() {
  ...
  const { mounted, loading, settings, providers, activeId, activeModel, saved, up, save, reset, setActiveId, setActiveModel, setProviders } = useSettings(locale, setLocale, t);

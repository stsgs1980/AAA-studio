  ...
  return (
    <div className="p-4 md:p-6 space-y-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">{t.pages['Agent Management']}</h1>
          <p className="text-sm text-muted-foreground">
            {t.pages['Create, configure and manage AI agents with custom roles and capabilities.']}
          </p>
        </div>
      </div>

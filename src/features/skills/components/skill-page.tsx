    ...
    <div className="p-6 space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Skill Forge</h1>
        </div>
      ...
      {showNew && (
        <div className="flex items-end gap-2 rounded-xl border border-border bg-card p-3">
          ...
          <button onClick={() => setShowNew(false)}
            className="h-9 px-3 rounded-lg border border-border text-muted-foreground hover:bg-muted text-sm">Cancel</button>
        </div>
      )}

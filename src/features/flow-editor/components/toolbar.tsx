...
export function Toolbar() {
  const { flowName, isDirty, canUndo, canRedo, undo, redo, clearCanvas } = useFlowEditorStore();
  ...
  return (
    <div className="flex items-center gap-1 border-b bg-card px-3 py-1.5 shrink-0">
      <div className="flex items-center gap-2 mr-4 min-w-0">
        ...
        {message && <span className="text-[10px] text-emerald-400 font-medium shrink-0">{message}</span>}
      </div>

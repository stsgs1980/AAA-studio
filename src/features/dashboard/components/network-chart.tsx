        ...
        <svg viewBox={`0 0 ${W} ${H}`} width="100%" preserveAspectRatio="xMidYMid meet"
          ...
          <defs>
            <linearGradient id="gradApi" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="var(--chart-green-500)" stopOpacity="0.25" />
              <stop offset="100%" stopColor="var(--chart-green-500)" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="gradFail" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="var(--chart-red-500)" stopOpacity="0.15" />
              <stop offset="100%" stopColor="var(--chart-red-500)" stopOpacity="0" />
            </linearGradient>
          </defs>
          ...
          {apiCalls.length > 0 && (
            <>
              ...
              <polyline points={apiPoints} fill="none" stroke="var(--chart-green-500)" strokeWidth="3"
          ...
          {failures.length > 0 && (
            <>
              ...
              <polyline points={failPoints} fill="none" stroke="var(--chart-red-500)" strokeWidth="2"
                strokeLinecap="round" strokeLinejoin="round"
                strokeDasharray="6 4"
                style={{

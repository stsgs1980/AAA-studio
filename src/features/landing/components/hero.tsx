      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 text-center">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-card/80 px-4 py-1.5 text-sm text-muted-foreground">
            ...
            {t.landing['Open Source Visual IDE']}
          </div>
        </motion.div>
        ...
        >
          {t.landing.Design}{" "}
          <span className="gradient-text">{t.landing['Multi-Agent']}</span>
          {" "}{t.landing['Systems Visually']}
        </motion.h1>
        ...
        >
          {t.landing['Build, deploy, and orchestrate intelligent AI agent systems with a powerful visual editor.']}
        </motion.p>
        ...
        >
          {t.landing['Drag-and-drop flow editor, prompt engineering studio, real-time monitoring, and multi-agent orchestration.']}
        </motion.p>

            ...
            <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
              {task.status === 'pending' && (
                <button
                  ...
                  className="text-xs bg-blue-500/10 text-blue-600 dark:text-blue-400 px-2 py-0.5 rounded hover:bg-blue-500/20"
                >
                  Start
                </button>
              )}
              {task.status === 'running' && (
                <button
                  ...
                  className="text-xs bg-green-500/10 text-green-600 dark:text-green-400 px-2 py-0.5 rounded hover:bg-green-500/20"
                >
                  Complete
                </button>
              )}

...
export function EdgeTypesPage() {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-text-primary">Edge Types</h2>
      ...
      <div className="space-y-3">
        {[
          ...
          <div key={edge.name} className="rounded-md border border-midnight-border p-3">
            <p className={`text-sm font-semibold ${edge.color}`}>{edge.name}</p>
            <p className="mt-1 text-sm text-text-secondary">{edge.desc}</p>
